...
Use `ValueEnum` + kebab-case names to preserve CLI/help compatibility.
...
- For `mmr`, keep read-command flags automation-friendly: optional `--source`, explicit `--all`, and clear help text for cwd-scoped defaults.
