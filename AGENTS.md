...
- `src/messages/service.rs`: in-memory aggregation, filtering, sorting, pagination, and response assembly.
- `src/types/query.rs`: query aggregate structs and helper state used by `QueryService`.
