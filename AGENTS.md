...
- `src/types/`: public API response types, remember request/response types, and sort/source enums.
...
- `docs/references/remember-command.md`: operator-facing reference for `mmr remember`, including backend setup, prompt behavior, and troubleshooting.
