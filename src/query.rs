...
struct SessionAggregateState {
    ...
    user_messages: i32,
    assistant_messages: i32,
    preview: Option<PreviewCandidate>,
}
...
/// A resolved project may match multiple names across sources (e.g. Codex uses paths,
